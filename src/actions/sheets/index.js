...
export const getNonPublishedSheets = () => {
  return (dispatch, getState) => {
    ...
    axios
      .get(
        `${apiDomain}/api/sheets/non-published`,
...
export const getOneSheet = (sheetId) => {
  return (dispatch) => {
    ...
    return axios
      .get(`${apiDomain}/api/sheets/one-public-sheet/${sheetId}`)
      .then((res) => {
...
export const toggleFavorites = (sheetId) => {
  return (dispatch, getState) => {
    axios
      .patch(
        `${apiDomain}/api/sheets/toggle-favorites/${sheetId}`,
        {},
        tokenConfig(getState().auth?.token)
      )
      .then((res) => {
